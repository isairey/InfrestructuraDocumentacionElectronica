...
public class ObjectFactory {
    ...
    private final static QName _AuditoriaEsb_QNAME = new QName("http://justicia.es/esb/comun/xsd-schemas/V1", "AuditoriaEsb");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.justicia.esb.comun.xsd_schemas.v1
     * 
     */
    ...
    public JAXBElement<AuditoriaEsbType> createAuditoriaEsb(AuditoriaEsbType value) {
        return new JAXBElement<AuditoriaEsbType>(_AuditoriaEsb_QNAME, AuditoriaEsbType.class, null, value);
    }
