...
public class ObjectFactory {
    ...
    private final static QName _ErrorEsb_QNAME = new QName("http://justicia.es/esb/error/xsd-schemas/V1", "ErrorEsb");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.justicia.esb.error.xsd_schemas.v1
     * 
     */
