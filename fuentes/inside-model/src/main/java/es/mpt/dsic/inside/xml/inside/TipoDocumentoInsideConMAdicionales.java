...
/**
 * <p>Java class for TipoDocumentoInsideConMAdicionales complex type.
 * 
...
@XmlType(name = "TipoDocumentoInsideConMAdicionales", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e", propOrder = {
    "documento",
