...
/**
 * <p>Java class for ExpedienteResultadoBusqueda complex type.
 * 
...
@XmlType(name = "ExpedienteResultadoBusqueda", namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/busqueda/resultados", propOrder = {
    "paginador",
    "resultados"
})
public class ExpedienteResultadoBusqueda {
    ...
    public static class Resultados {
        ...
        @XmlElement(namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/busqueda/resultados", required = true)
