...
public class ObjectFactory {
    ...
    private final static QName _DocumentoAltaMtom_QNAME = new QName("https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/alta/mtom", "documentoAltaMtom");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.mpt.dsic.inside.xml.inside.ws.documento.alta.mtom
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TipoDocumentoAltaInsideMtom }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/documento-e/alta/mtom", name = "documentoAltaMtom")
    public JAXBElement<TipoDocumentoAltaInsideMtom> createDocumentoAltaMtom(TipoDocumentoAltaInsideMtom value) {
        return new JAXBElement<TipoDocumentoAltaInsideMtom>(_DocumentoAltaMtom_QNAME, TipoDocumentoAltaInsideMtom.class, null, value);
    }
