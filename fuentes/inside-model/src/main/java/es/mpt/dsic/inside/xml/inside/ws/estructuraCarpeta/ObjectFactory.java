 ...
 * generated in the es.mpt.dsic.inside.xml.inside.ws.estructuraCarpeta package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.mpt.dsic.inside.xml.inside.ws.estructuraCarpeta
     * 
     */
