...
/**
 * <p>Java class for TipoExpedienteConversionInside complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TipoExpedienteConversionInside">
 *   &lt;complexContent>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="Indice" type="{https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/conversion}TipoIndiceConversion"/>
 *         &lt;element name="OpcionesVisualizacion" type="{https://ssweb.seap.minhap.es/Inside/XSD/v1.0/expediente-e/conversion}TipoOpcionesVisualizacionIndice"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "TipoExpedienteConversionInside", propOrder = {
    "metadatosEni",
    "indice",
    "opcionesVisualizacion"
})
public class TipoExpedienteConversionInside {

    @XmlElement(required = true)
    protected TipoExpedienteConversionInside.MetadatosEni metadatosEni;
    @XmlElement(name = "Indice", required = true)
    protected TipoIndiceConversion indice;
    @XmlElement(name = "OpcionesVisualizacion", required = true)
    protected TipoOpcionesVisualizacionIndice opcionesVisualizacion;
     ...
     * @return
     *     possible object is
     *     {@link TipoExpedienteConversionInside.MetadatosEni }
     *     
     */
    public TipoExpedienteConversionInside.MetadatosEni getMetadatosEni() {
        return metadatosEni;
    }
     ...
     *     
     */
    public void setMetadatosEni(TipoExpedienteConversionInside.MetadatosEni value) {
     ...
     *     
     */
    public TipoIndiceConversion getIndice() {
        return indice;
    }
     ...
     *     
     */
    public void setIndice(TipoIndiceConversion value) {
        this.indice = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link TipoOpcionesVisualizacionIndice }
     *     
     */
    public TipoOpcionesVisualizacionIndice getOpcionesVisualizacion() {
     ...
     *     
     */
    public void setOpcionesVisualizacion(TipoOpcionesVisualizacionIndice value) {
    ...
    public static class MetadatosEni {
        ...
        protected TipoExpedienteConversionInside.MetadatosEni.Estado estado;
         ...
         * @return
         *     possible object is
         *     {@link TipoExpedienteConversionInside.MetadatosEni.Estado }
         *     
         */
        public TipoExpedienteConversionInside.MetadatosEni.Estado getEstado() {
            return estado;
        }
         ...
         *     
         */
        public void setEstado(TipoExpedienteConversionInside.MetadatosEni.Estado value) {
            this.estado = value;
        }
