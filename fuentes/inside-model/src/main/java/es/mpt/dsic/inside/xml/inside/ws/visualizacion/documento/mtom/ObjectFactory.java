...
public class ObjectFactory {
    ...
    private final static QName _DocumentoVisualizacionMtom_QNAME = new QName("https://ssweb.seap.minhap.es/Inside/XSD/v1.0/visualizacion/documento-e/mtom", "documentoVisualizacionMtom");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.mpt.dsic.inside.xml.inside.ws.visualizacion.documento.mtom
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TipoDocumentoVisualizacionInsideMtom }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "https://ssweb.seap.minhap.es/Inside/XSD/v1.0/visualizacion/documento-e/mtom", name = "documentoVisualizacionMtom")
    public JAXBElement<TipoDocumentoVisualizacionInsideMtom> createDocumentoVisualizacionMtom(TipoDocumentoVisualizacionInsideMtom value) {
        return new JAXBElement<TipoDocumentoVisualizacionInsideMtom>(_DocumentoVisualizacionMtom_QNAME, TipoDocumentoVisualizacionInsideMtom.class, null, value);
    }
